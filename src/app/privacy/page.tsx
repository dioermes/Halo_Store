...
export default function PrivacyPage() {
  ...
  return (
    <article className="mx-auto max-w-2xl px-5 py-24 leading-relaxed text-ivory-dim">
      ...
      <p className="mt-3 text-sm">Ultimo aggiornamento: 24 agosto 2026</p>
      ...
      <p className="mt-4">
        Dati tecnici necessari al sito: sessione, carrello, scelte sui cookie. Le statistiche e
        gli annunci partono solo se li accendi nel banner.
      </p>
      ...
      <p className="mt-4">
        ...
        cookie. Puoi revocarlo in ogni mail, dal link «Disiscriviti», o dalle preferenze.
      </p>
      <p className="mt-4">
      ...
      <p className="mt-4">
        ...
        Newsletter: finché resti iscritto, poi cessiamo gli invii promozionali. Cookie di
        preferenza: secondo la scelta nel banner.
      </p>
